...
final as (
    ...
    select
        ...
        r.is_postseason,
        r.games,
        ifnull(r.at_bats, 0) + ifnull(r.walks, 0) + ifnull(r.hit_by_pitches, 0) + ifnull(r.sacrifice_hits, 0) + ifnull(r.sacrifice_flies, 0) as plate_appearances,
        r.at_bats,
        r.runs,
        r.hits,
        r.doubles,
        r.triples,
        r.home_runs,
        r.hits + r.walks + ifnull(r.hit_by_pitches, 0) as times_on_base,
        r.at_bats + r.walks + ifnull(r.hit_by_pitches, 0) + ifnull(r.sacrifice_flies, 0) as on_base_denominator,
