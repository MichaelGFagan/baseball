...
final as (
    ...
    select
      ...
      , transformed.games
      , ifnull(at_bats, 0) + ifnull(transformed.walks, 0) + ifnull(transformed.hit_by_pitches, 0) + ifnull(transformed.sacrifice_hits, 0) + ifnull(transformed.sacrifice_flies, 0) as plate_appearances
      , transformed.at_bats
      , transformed.runs
      , transformed.hits
      , transformed.doubles
