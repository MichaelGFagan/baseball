...
transformed as (
        ...
        select
        {{ dbt_utils.surrogate_key(['chadwick.person_id', 'batting.stint_id', 'batting.team_id', 'batting.lg_id', 'batting.year_id', 'FALSE']) }} as player_stint_year_id
      , {{ dbt_utils.surrogate_key(['chadwick.person_id', 'batting.team_id', 'batting.year_id']) }} as player_year_team_id
      , {{ dbt_utils.surrogate_key(['chadwick.person_id', 'batting.year_id']) }} as player_year_id
      , chadwick.person_id
      ...
      , batting.opprppa_rep as average_team_runs_allowedd_per_plate_appearance_against_replacement
      , batting.opprpg_rep as average_team_runs_allowed_per_game_against_replacement
      , batting.pyth_exponent as pythagenpat_exponent
      , batting.pyth_exponent_rep as pythagenpat_exponent_replacement
      , batting.waa_win_perc as wins_above_average_win_percentage_with_average_team
      , batting.waa_win_perc_off as wins_above_average_win_percentage_with_average_team_offense
      , batting.waa_win_perc_def as wins_above_average_win_percentage_with_average_team_defense
      , batting.waa_win_perc_rep as wins_above_average_win_percentage_with_average_team_replacement
      , batting.ops_plus on_base_plus_slugging_plus
