...
transformed as (
    ...
    select
        ...
        s.hits as hits_allowed,
        s.runs as runs_allowed,
        s.earned_runs as earned_runs_allowed,
        s.home_runs as home_runs_allowed,
        ...
        s.sacrifice_flies as sacrifice_flies_allowed,
        s.ground_into_double_plays as ground_into_double_plays_induced,
        {{ no_divide_by_zero('s.hits', 's.batters_faced - s.walks - s.hit_by_pitches - s.sacrifice_hits - s.sacrifice_flies', 3) }} as batting_average_against,
        {{ no_divide_by_zero('s.hits - s.home_runs', 's.batters_faced - s.walks - s.hit_by_pitches - s.sacrifice_hits - s.strikeouts - s.home_runs', 3) }} as batting_average_on_balls_in_play,
        {{ no_divide_by_zero('s.runs', 's.outs_pitched * 27', 2) }} as runs_allowed_average,
        {{ no_divide_by_zero('s.earned_runs', 's.outs_pitched * 27', 2) }} as earned_runs_allowed_average,
        ...
        {{ no_divide_by_zero('s.hits', 's.outs_pitched * 27', 1) }} as hits_allowed_per_nine,
        {{ no_divide_by_zero('s.home_runs', 's.outs_pitched * 27', 1) }} as home_runs_allowed_per_nine,
        {{ no_divide_by_zero('s.walks', 's.outs_pitched * 27', 1) }} as walks_allowed_per_nine,
        {{ no_divide_by_zero('s.walks', 's.strikeouts', 2) }} as walks_allowed_per_strikeout_thrown,
        {{ no_divide_by_zero('s.strikeouts', 's.batters_faced', 3) }} as strikeouts_thrown_rate,
        {{ no_divide_by_zero('s.walks', 's.batters_faced', 3) }} as walks_allowed_rate,
        {{ no_divide_by_zero('s.home_runs', 's.batters_faced', 3) }} as home_runs_allowed_rate
